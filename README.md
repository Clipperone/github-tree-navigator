...
Found a security vulnerability? Please report it **privately** — see [SECURITY.md](SECURITY.md). Do not open a public issue for security reports.

## License

GitHub Tree Navigator is released under the [MIT License](LICENSE).
